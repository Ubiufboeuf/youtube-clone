export function Devices () {
  return (
    <div className='fixed left-1/2 top-1/2 z-[999] [transform:translate(-50%,-50%)] w-fit h-fit text-2xl justify-center items-center'>
      ...
      <p>Guarda si usas user agents personalizados</p>
    </div>
  )
}
