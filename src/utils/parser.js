...
export function parseDuration (duration) {
  ...
  const mm = `${Math.floor((duration - (3600 * hh)) / 60)}`.padStart(1, '0')
...
export function parsePublicationDate (publicationDate) {
  ...
  // Para que no tengas que leer de abajo, se encarga de mostrar hace cuánto se publicó el video: años, meses, etc
